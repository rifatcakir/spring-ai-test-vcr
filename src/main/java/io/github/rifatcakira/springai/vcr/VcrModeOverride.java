 ...
 * real provider, or an assertion on something {@link io.github.rifatcakira.springai.vcr.track.VcrTrack}
 * deliberately drops — while the rest of a {@link VcrMode#REPLAY_ONLY} CI run stays sealed.
 * Most users should reach for
 * {@link io.github.rifatcakira.springai.vcr.junit.Vcr @Vcr} rather than this class directly;
