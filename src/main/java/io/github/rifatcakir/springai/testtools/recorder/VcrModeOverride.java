 ...
 * real provider, or an assertion on something {@link io.github.rifatcakir.springai.testtools.recorder.track.VcrTrack}
 * deliberately drops — while the rest of a {@link VcrMode#REPLAY_ONLY} CI run stays sealed.
 * Most users should reach for
 * {@link io.github.rifatcakir.springai.testtools.recorder.junit.Vcr @Vcr} rather than this class directly;
